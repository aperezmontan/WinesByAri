  ...
  render () {
    return (
      <tr data-toggle="collapse" className="accordion-toggle">
        ...
        <td className="text-center"><a data-method="get" href={'products/' + this.props.product._id["$oid"]}>#</a></td>
        <td className="text-center"><a data-method="get" href={'products/' + this.props.product._id["$oid"] + '/edit'}>#</a></td>
